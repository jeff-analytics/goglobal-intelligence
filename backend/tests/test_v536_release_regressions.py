...
def test_launcher_prevents_stale_backend_and_ui_port_reuse():
    ...
    assert "v541-20260901-algorithms-ai-config-r2" in run
    ...
    assert "v541-20260901-algorithms-ai-config-r2" in mac
...
def test_health_exposes_exact_release_build_id():
    ...
    assert body["build"] == "v541-20260901-algorithms-ai-config-r2"
