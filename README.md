...
BorderMargin is a bilingual decision-intelligence application for evaluating product-market opportunities with structured trade evidence, tariff and tax research, marketplace signals, unit economics, and agentic web research.
...
- **Market scan** — compare selected markets using trade evidence and market readiness signals.
...
- **Cost & margin** — configurable product economics, reverse pricing and target-margin analysis.
...
- **Portfolio analysis** — compare multiple product-market opportunities through a consistent evidence framework.
...
2. Run run_win.bat.
3. BorderMargin opens at http://127.0.0.1:5173.
```
...
Repository folders stay version-neutral. Releases are tracked with Git tags such as `v5.3.8` and documented in [CHANGELOG.md](CHANGELOG.md).
